    ...
    >
      <div class="mb-4">
        ...
        <input
          ...
          id="username"
        />
        <h5 id="usernameHelp" class="form-text text-muted" v-if="errorMsg.length">
        ...
        <input
          ...
          id="password"
        />
        <h5 id="passwordHelp" class="form-text text-muted" v-if="errorMsg.length">
        ...
        <input
          ...
          id="password2"
        />
        <h5 id="confirmPasswordHelp" class="form-text text-muted" v-if="errorMsg.length">
